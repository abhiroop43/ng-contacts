...
export class ContactsEffects {
  ...
  contactsFetch = this.actions
    ...
    .switchMap((action: ContactsActions.FetchContacts) => {
  ...
  contactAdd = this.actions.ofType(ContactsActions.ADD_CONTACT).do(() => {
    this.router.navigate(['/contacts']);
  });

  @Effect({ dispatch: false })
  contactUpdate = this.actions.ofType(ContactsActions.UPDATE_CONTACT).do(() => {
    this.router.navigate(['/contacts']);
  });
